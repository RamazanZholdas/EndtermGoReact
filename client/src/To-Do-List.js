...
//create class ToDoList with items array
class ToDoList extends Component {
                            ...
                            <Card key={item._id} color={color} fluid className="rough">
                                <Card.Content>
                                    ...
                                    <Card.Meta textAlign="right">
                                        ...
                                        <Icon name="undo" color="blue" onClick={()=> this.undoTask(item._id)}/> 
    ...
    undoTask = (id) => {
        axios.put(endpoint+'/api/undoTasks/'+id, {
            headers:{
                "Content-Type": "application/x-www-form-urlencoded",
            },
        }).then((res)=>{
    ...
    render() {
        return (
            <div>
                <div className='row'>   
                    <Header as='h2' className="Header" color = "yellow">
                        To Do List 
                    </Header>
                </div>
                <div className='row'>
